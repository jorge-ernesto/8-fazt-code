...
path = "Recursos/1 Modelos/ESPCN_x4.pb"  # Necesitas descargar este archivo
sr.readModel(path)

# Establecer el modelo y el factor de escala
sr.setModel("espcn", 4)  # Cambiar a "fsrcnn" para velocidad
...
cv2.imwrite("Recursos/3 Imagenes/imagen_mejorada_IA_rapido_espcn.jpg", result)
