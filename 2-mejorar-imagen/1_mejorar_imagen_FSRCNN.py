...
path = "Recursos/1 Modelos/FSRCNN_x4.pb"  # Necesitas descargar este archivo
sr.readModel(path)

# Establecer el modelo y el factor de escala
sr.setModel("fsrcnn", 4)  # Cambiar a "fsrcnn" para velocidad
...
cv2.imwrite("Recursos/3 Imagenes/imagen_mejorada_IA_rapido_fsrcnn.jpg", result)
